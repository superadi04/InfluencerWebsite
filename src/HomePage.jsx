  ...
  return (
    <div className="bg-black absolute top-0 left-0 w-full">
              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  <div className="flow-root">
                    <a href="#" className="-m-2 block p-2 font-medium text-gray-200">
                      Sign in
                    </a>
                  </div>
                  <div className="flow-root">
      ...
      <header className="relative overflow-hidden">
        {/* Top navigation */}
        <nav aria-label="Top" className="relative z-20 bg-black bg-opacity-90 backdrop-blur-xl backdrop-filter">
                ...
                <div className="flex h-full space-x-8">
                            ...
                            <Popover.Button
                              className={classNames(
                                open
                                  ...
                                  : 'border-transparent text-gray-200 hover:text-gray-800',
                  ...
                  {navigation.pages.map((page) => (
                    <a
                      key={page.name}
                      href={page.href}
                      className="flex items-center text-sm font-medium text-gray-200 hover:text-gray-800"
                    >
                      {page.name}
                    </a>
                  ))}
          ...
          <div className="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
            <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
              <div className="sm:max-w-lg">
                <h1 className="text-4xl font-bold tracking-tight text-gray-200 sm:text-6xl text-left">
                  Create Your Virtual Online Influencer 
                </h1>
                <p className="mt-4 text-xl text-gray-500 text-left">
                Jit is the all-in-one solution for creating, growing, and monetizing your AI influencer to the next level
              </p>
            </div>
            <div>
              <div className="mt-10">
